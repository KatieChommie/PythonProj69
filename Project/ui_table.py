...
"}")
        ...
        icon = QIcon()
        icon.addFile(u"img/t1.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tbtn_table1.setIcon(icon)
        ...
        icon2 = QIcon()
        icon2.addFile(u"img/t3.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tbtn_table3.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"img/t4.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tbtn_table4.setIcon(icon3)
        ...
        icon6 = QIcon()
        icon6.addFile(u"img/t7.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tbtn_table7.setIcon(icon6)
...
"}")
        ...
        self.lineEdit.setMaximumSize(QSize(400, 100))

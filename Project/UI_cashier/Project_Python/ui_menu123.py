...
################################################################################
## Form generated from reading UI file 'menu123.ui'
##
...
class Ui_MainMenu(object):
    def setupUi(self, MainMenu):
        ...
        MainMenu.resize(1045, 665)
        MainMenu.setStyleSheet(u"QToolButton {\n"
...
"}")
        ...
        icon = QIcon()
        icon.addFile(u"C:/Users/NEXT Speed/Downloads/UI_cashier/Project_Python/img/3.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"C:/Users/NEXT Speed/Downloads/UI_cashier/Project_Python/img/search.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border: 1px solid #212121;\n"
"}")
        self.category.setFrameShape(QFrame.Shape.StyledPanel)
        self.category.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        ...
        self.menuGrid.setGeometry(QRect(0, 0, 602, 1020))
        ...
        self.btn_steak_grillfish.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_bread.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_spinach.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_coke_jug.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_hamcheese.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_pepper.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_friedfish.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_burger_teriyaki.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_porkchop.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_redsoda.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_bluehawaiian.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_burger_spicy.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_ice.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_water.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_frenchfries.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_salad_tuna.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_salad_apple.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_spaghetti_tomyum.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_garlic.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.btn_steak_garlic.setAutoRaise(False)
        self.btn_steak_garlic.setArrowType(Qt.ArrowType.NoArrow)
        ...
        self.btn_burger_fish.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_passionfruit.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_burger_bacon.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_salad_vegetable.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_potatoes.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_spicy.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_spaghetti_drunk.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_spaghetti_carbonara.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_lemontea.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_coke_glass.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_steak_teriyaki.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.btn_onion.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
...
"}")
        ...
        self.pbtn_table.setContextMenuPolicy(Qt.ContextMenuPolicy.NoContextMenu)
        self.pbtn_table.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
...
"}")
        ...
        self.lbl_current_table.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.order.setFont(font3)
        self.order.setStyleSheet(u"QTableWidget {\n"
"border: 1px solid #212121;\n"
"}")
        self.order.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.order.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
        ...
        self.lbl_total.setFont(font4)
        self.lbl_total.setStyleSheet(u"")

        self.verticalLayout_2.addWidget(self.lbl_total)
        ...
        self.summary.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
    ...
    def retranslateUi(self, MainMenu):
        ...
        self.tbtn_all.setText(QCoreApplication.translate("MainMenu", u"\u0e17\u0e31\u0e49\u0e07\u0e2b\u0e21\u0e14", None))
        self.tbtn_cat_steak.setText(QCoreApplication.translate("MainMenu", u"\u0e2a\u0e40\u0e15\u0e47\u0e01", None))
        self.tbtn_cat_burger.setText(QCoreApplication.translate("MainMenu", u"\u0e40\u0e1a\u0e2d\u0e23\u0e4c\u0e40\u0e01\u0e2d\u0e23\u0e4c", None))
        self.tbtn_cat_spaghetti.setText(QCoreApplication.translate("MainMenu", u"\u0e2a\u0e1b\u0e32\u0e40\u0e01\u0e15\u0e15\u0e35", None))
        self.tbtn_cat_salad.setText(QCoreApplication.translate("MainMenu", u"\u0e2a\u0e25\u0e31\u0e14", None))
        self.tbtn_cat_snack.setText(QCoreApplication.translate("MainMenu", u"\u0e17\u0e32\u0e19\u0e40\u0e25\u0e48\u0e19", None))
        self.tbtn_cat_drink.setText(QCoreApplication.translate("MainMenu", u"\u0e40\u0e04\u0e23\u0e37\u0e48\u0e2d\u0e07\u0e14\u0e37\u0e48\u0e21", None))
        self.btn_steak_grillfish.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_bread.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_spinach.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_coke_jug.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_hamcheese.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_pepper.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_friedfish.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_burger_teriyaki.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_porkchop.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_redsoda.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_bluehawaiian.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_burger_spicy.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_ice.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_water.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_frenchfries.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_salad_tuna.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_salad_apple.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_spaghetti_tomyum.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_garlic.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_burger_fish.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_passionfruit.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_burger_bacon.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_salad_vegetable.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_potatoes.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_spicy.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_spaghetti_drunk.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_spaghetti_carbonara.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_lemontea.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_coke_glass.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_steak_teriyaki.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.btn_onion.setText(QCoreApplication.translate("MainMenu", u"...", None))
        self.pbtn_table.setText(QCoreApplication.translate("MainMenu", u"\u0e40\u0e25\u0e37\u0e2d\u0e01\u0e42\u0e15\u0e4a\u0e30", None))
        self.lbl_current_table.setText(QCoreApplication.translate("MainMenu", u"\u0e42\u0e15\u0e4a\u0e30\u0e17\u0e35\u0e48 ", None))
        ___qtablewidgetitem = self.order.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainMenu", u"\u0e23\u0e32\u0e22\u0e01\u0e32\u0e23", None));
        ___qtablewidgetitem1 = self.order.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainMenu", u"\u0e08\u0e33\u0e19\u0e27\u0e19", None));
        ___qtablewidgetitem2 = self.order.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainMenu", u"\u0e22\u0e2d\u0e14\u0e23\u0e27\u0e21 (\u0e1a\u0e32\u0e17)", None));
        self.lbl_total.setText(QCoreApplication.translate("MainMenu", u"0.00", None))
        self.pbtn_clear.setText(QCoreApplication.translate("MainMenu", u"Clear", None))
        self.pbtn_save.setText(QCoreApplication.translate("MainMenu", u"\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01", None))
        self.pbtn_pay.setText(QCoreApplication.translate("MainMenu", u"\u0e17\u0e33\u0e23\u0e32\u0e22\u0e01\u0e32\u0e23", None))
    # retranslateUi
